...
def brightness(phrase: str):
    ...
    elif "decrease" in phrase or "reduce" in phrase or "lower" in phrase or "dark" in phrase or "dim" in phrase:
        Thread(target=pybrightness.decrease, args=(logger,)).start()
    elif "increase" in phrase or "bright" in phrase or "max" in phrase or "brighten" in phrase or "light up" in phrase:
