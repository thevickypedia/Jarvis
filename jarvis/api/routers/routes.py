...
class Endpoints(StrEnum):
    ...
    bot_endpoint = models.env.bot_endpoint
...
API_ROUTES = [
    ...
    APIRoute(
        endpoint=stock_analysis.get_signals, methods=["GET"], path=Endpoints.get_signals
    ),
    APIRoute(
        endpoint=proxy_service.proxy_service_api, methods=["GET"], path=Endpoints.proxy
    ),
    APIRoute(
